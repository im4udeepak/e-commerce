...
(function ($) {
    ...
    $(".color-1").on("click", function () {
        $("#add_class").remove();
        localStorage.setItem("colorStyle", "color-1");
        $("head").append(
    ...
    $(".color-2").on("click", function () {
        $("#add_class").remove();
        localStorage.setItem("colorStyle", "color-2");
        $("head").append(
    ...
    $(".color-3").on("click", function () {
        $("#add_class").remove();
        localStorage.setItem("colorStyle", "color-3");
        $("head").append(
    ...
    $(".color-4").on("click", function () {
        $("#add_class").remove();
        localStorage.setItem("colorStyle", "color-4");
        $("head").append(
    ...
    $(".color-6").on("click", function () {
        $("#add_class").remove();
        localStorage.setItem("colorStyle", "color-6");
        $("head").append(
    ...
    $(".color-7").on("click", function () {
        $("#add_class").remove();
        localStorage.setItem("colorStyle", "color-7");
        $("head").append(
    ...
    $(".color-8").on("click", function () {
        $("#add_class").remove();
        localStorage.setItem("colorStyle", "color-8");
        $("head").append(
    ...
    $(".color-9").on("click", function () {
        $("#add_class").remove();
        localStorage.setItem("colorStyle", "color-9");
        $("head").append(
    ...
    $(".box-1").on("click", function () {
        localStorage.setItem("designMode", "box-1");
        $("head").append(
    ...
    $(window).on("load", function () {
        if (localStorage.getItem("colorStyle")) {
            $("#add_class").remove();
            $("head").append(
                '<link rel="stylesheet" href="assets/css/' + localStorage.getItem("colorStyle") + '.css" id="add_class">'
            );
            $(".bb-color li").removeClass("active-variant");
            $(`.${localStorage.getItem("colorStyle")}`).addClass("active-variant");
        }
        if (localStorage.getItem("colorMode")) {
            $("#add_dark").remove();
            $("head").append(
                '<link rel="stylesheet" href="assets/css/' + localStorage.getItem("colorMode") + '.css" id="add_dark">'
            );
            $(".bb-tools-dark div").removeClass("active-dark");
            $(`.${localStorage.getItem("colorMode")}`).addClass("active-dark");
        }
        if (localStorage.getItem("layoutMode")) {
            $("#add_rtl").remove();
            $("head").append(
                '<link rel="stylesheet" href="assets/css/' + localStorage.getItem("layoutMode") + '.css" id="add_rtl">'
            );
            $(".bb-tools-rtl div").removeClass("active-rtl");
            $(`.${localStorage.getItem("layoutMode")}`).addClass("active-rtl");
        }
        if (localStorage.getItem("designMode")) {
            $("#add_box").remove();
            $("head").append(
                '<link rel="stylesheet" href="assets/css/' + localStorage.getItem("designMode") + '.css" id="add_box">'
            );
            $(".bb-tools-box div").removeClass("active-box");
            $(`.${localStorage.getItem("designMode")}`).addClass("active-box");
        }
    });
